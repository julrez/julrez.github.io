import{S as Na,i as Ua,s as Ha,k as r,a as f,q as n,l,c as h,m as u,r as o,h as t,N as Aa,n as p,p as wa,b as i,G as s,B as Gt}from"./index-d063f04b.js";function Ga(_a){let m,Ct,fe,w,he,D,Se,ce,B,qe,de,g,je,V,Ke,Je,$,Oe,Qe,pe,M,Ve,me,Z,$e,ge,X,et,ye,Y,tt,be,F,at,xe,_,Ia=`<code class="language-undefined">@group(0) @binding(0) var outputTexture: texture_storage_2d&lt;rgba16float, write&gt;;
...
&#123;
    ...
    &#125;&#125;&#125;
&#125;</code>`,Ge,j,Ut,Ce,K,Ht,We,J,At;return{c(){m=r("img"),fe=f(),w=r("link"),he=f(),D=r("p"),Se=n(`In the last 2 weeks I have transitioned from webgl to webgpu and added a more performant rendering system.
...
needed. I implemented a buffer and if the `),V=r("i"),Ke=n("shaderDebugEnabled"),Je=n(` flag is true, then that buffer is bound
to every single shader pipeline. Then in the shaders I have implemented a `),$=r("i"),Oe=n("debug_print"),Qe=n(` function which
...
I use a 3d summed area table which is a little bit more complex.`),Ae=f(),T=r("pre"),Ge=f(),j=r("p"),Ut=n("The code for generating the cuboids for the empty voxels is very similar."),Ce=f(),K=r("h2"),Ht=n("Conclusion"),We=f(),J=r("p"),At=n(`With this system I have a simple version of ray-tracing up and running.
...
I also tried out creating all the chunks for the game in C with webassembly, however, I have not yet ported
that chunks load as you move. Right now lots of chunks load the second you load the page.
Additionally, a skybox has been implemented.`),a.forEach(t),ce=h(e),B=l(e,"H2",{});var Wt=u(B);qe=o(Wt,"Why did I switch to webGPU?"),Wt.forEach(t),de=h(e),g=l(e,"P",{});var O=u(g);je=o(O,`The reason I went for webGPU is because that I can have compute shaders, which I emulated with fragment
shaders before. However, the best thing to come from switching to webGPU is better debugging which I really
needed. I implemented a buffer and if the `),V=l(O,"I",{});var Rt=u(V);Ke=o(Rt,"shaderDebugEnabled"),Rt.forEach(t),Je=o(O,` flag is true, then that buffer is bound
to every single shader pipeline. Then in the shaders I have implemented a `),$=l(O,"I",{});var St=u($);Oe=o(St,"debug_print"),St.forEach(t),Qe=o(O,` function which
makes me able to console.log in a compute shader! This is not perfect but much better than nothing that I had
when using webGL.`),O.forEach(t),pe=h(e),M=l(e,"H2",{});var qt=u(M);Ve=o(qt,"Why did I switch to using C with webassembly"),qt.forEach(t),me=h(e),Z=l(e,"P",{});var jt=u(Z);$e=o(jt,"Doing integer operations with floats and no static typing was just not fun."),jt.forEach(t),ge=h(e),X=l(e,"H2",{});var Kt=u(X);et=o(Kt,"A dive into the ray-traced shadows"),Kt.forEach(t),ye=h(e),Y=l(e,"P",{});var Jt=u(Y);tt=o(Jt,"With webGPU, you use the shading language wgsl which I now will show with the shadow tracing compute shader."),Jt.forEach(t),be=h(e),F=l(e,"P",{});var Ot=u(F);at=o(Ot,`In the beginning of the shader, I have code to import resources from other shaders. This compute shader takes
the depth information from the previous primary ray compute shader to get the position from where to start tracing.
Therefore, quite a lot of resources are used.`),Ot.forEach(t),xe=h(e),_=l(e,"PRE",{class:!0});var Ba=u(_);Ba.forEach(t),ve=h(e),L=l(e,"P",{});var Qt=u(L);it=o(Qt,"In webGPU, resources get bound combined in a group, where every single resource get one binding in that group."),Qt.forEach(t),we=h(e),c=l(e,"P",{});var b=u(c);st=o(b,"The two most important resources that are used in most shaders are "),ee=l(b,"EM",{});var Vt=u(ee);nt=o(Vt,"chunkBuffer"),Vt.forEach(t),ot=o(b," and "),te=l(b,"EM",{});var $t=u(te);rt=o($t,"accelerationBuffer"),$t.forEach(t),lt=o(b,`.
